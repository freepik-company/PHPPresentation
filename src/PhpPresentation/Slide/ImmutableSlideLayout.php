...
class ImmutableSlideLayout extends AbstractSlide implements ComparableInterface, ShapeContainerInterface
{
    /**
     * @var SlideMaster
     */
    ...
    public function loadDomXML(\DOMDocument $document)
    {
        $this->domXML = $document;
    }
